...
@Component({
  selector: 'app-CGHSreport',
  templateUrl: './cghsreport-list.component.html',
  styleUrls: ['./cghsreport-list.component.css']
})




export class CGHSReportListComponent implements OnInit {
