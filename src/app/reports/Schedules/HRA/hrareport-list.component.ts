...
@Component({
  selector: 'app-HRAreport',
  templateUrl: './hrareport-list.component.html',
  styleUrls: ['./hrareport-list.component.css']
})


export class HRAReportListComponent implements OnInit {
