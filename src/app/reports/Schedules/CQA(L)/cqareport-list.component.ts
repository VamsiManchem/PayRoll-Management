...
@Component({
  selector: 'app-CQAreport',
  templateUrl: './cqareport-list.component.html',
  styleUrls: ['./cqareport-list.component.css']
})




export class CQAReportListComponent implements OnInit {
