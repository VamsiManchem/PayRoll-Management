...
@Component({
  selector: 'app-DRDLECSSreport',
  templateUrl: './eccsreport-list.component.html',
  styleUrls: ['./eccsreport-list.component.css']
})




export class ECCSReportListComponent implements OnInit {
