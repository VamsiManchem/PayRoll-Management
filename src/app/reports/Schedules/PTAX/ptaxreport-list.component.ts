...
@Component({
  selector: 'app-PTAXreport',
  templateUrl: './ptaxreport-list.component.html',
  styleUrls: ['./ptaxreport-list.component.css']
})




export class PTAXReportListComponent implements OnInit {
