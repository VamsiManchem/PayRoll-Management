...
@Component({
  selector: 'app-GPFNPSno',
  templateUrl: './gpfnpsreport-list.component.html',
  styleUrls: ['./gpfnpsreport-list.component.css']
})




export class GPFNPSReportListComponent implements OnInit {
