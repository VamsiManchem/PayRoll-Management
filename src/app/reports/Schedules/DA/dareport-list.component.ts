...
@Component({
  selector: 'app-DAreport',
  templateUrl: './dareport-list.component.html',
  styleUrls: ['./dareport-list.component.css']
})




export class DAReportListComponent implements OnInit {
