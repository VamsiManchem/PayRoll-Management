...
@Component({
  selector: 'app-CGEGISreport',
  templateUrl: './cgegisreport-list.component.html',
  styleUrls: ['./cgegisreport-list.component.css']
})




export class CGEGISReportListComponent implements OnInit {
