...
@Component({
  selector: 'app-MISCRECreport',
  templateUrl: './miscreport-list.component.html',
  styleUrls: ['./miscreport-list.component.css']
})




export class MISCRECReportListComponent implements OnInit {
