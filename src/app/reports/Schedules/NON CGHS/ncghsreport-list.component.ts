...
@Component({
  selector: 'app-NONCGHSreport',
  templateUrl: './ncghsreport-list.component.html',
  styleUrls: ['./ncghsreport-list.component.css']
})




export class NCGHSReportListComponent implements OnInit {
