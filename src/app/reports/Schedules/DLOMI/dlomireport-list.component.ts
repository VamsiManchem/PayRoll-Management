...
@Component({
  selector: 'app-DLOMIreport',
  templateUrl: './dlomireport-list.component.html',
  styleUrls: ['./dlomireport-list.component.css']
})




export class DLOMIReportListComponent implements OnInit {
